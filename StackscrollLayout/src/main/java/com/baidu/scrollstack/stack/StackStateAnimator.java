...
public class StackStateAnimator {
    ...
    public StackScrollLayout mHostLayout;
    private ArrayList<StackScrollLayout.AnimationEvent> mNewEvents =
            new ArrayList<>();
    ...
    public StackStateAnimator(StackScrollLayout hostLayout) {
    ...
    public void startAnimationForEvents(
            ArrayList<StackScrollLayout.AnimationEvent> mAnimationEvents,
        ...
        mCurrentLength = StackScrollLayout.AnimationEvent.combineLength(mNewEvents);
    ...
    private long calculateChildAnimationDelay(StackScrollState.ViewState viewState,
        ...
        long minDelay = 0;
        for (StackScrollLayout.AnimationEvent event : mNewEvents) {
            long delayPerElement = ANIMATION_DELAY_PER_ELEMENT_INTERRUPTING;
            switch (event.animationType) {
                case StackScrollLayout.AnimationEvent.ANIMATION_TYPE_ADD: {
                ...
                case StackScrollLayout.AnimationEvent.ANIMATION_TYPE_REMOVE_SWIPED_OUT:
                    delayPerElement = ANIMATION_DELAY_PER_ELEMENT_MANUAL;
                case StackScrollLayout.AnimationEvent.ANIMATION_TYPE_REMOVE: {
                    int ownIndex = viewState.notGoneIndex;
    ...
    private void processAnimationEvents(
            ArrayList<StackScrollLayout.AnimationEvent> animationEvents,
            StackScrollState finalState) {
        for (StackScrollLayout.AnimationEvent event : animationEvents) {
            final ExpandableView changingView = (ExpandableView) event.changingView;
            if (event.animationType ==
                    StackScrollLayout.AnimationEvent.ANIMATION_TYPE_ADD) {
                ...
                mNewAddChildren.add(changingView);
                    ...
                    StackScrollLayout.AnimationEvent.ANIMATION_TYPE_REMOVE) {
                if (changingView.getVisibility() == View.GONE) {
