...
import com.baidu.scrollstack.uitl.OverScroller;
import com.baidu.scrollstack.uitl.StackViewBaseAdapter;
import com.baidu.scrollstack.view.ExpandHelper;
import com.baidu.scrollstack.view.ExpandableView;
import com.baidu.scrollstack.view.ScrollAdapter;
import com.baidu.scrollstack.view.SwipeHelper;
 ...
 */
public class StackScrollLayout extends StackScrollLayoutParent
    ...
    private StackViewBaseAdapter mAdapter;
        ...
        public void onChanged() {
            ...
            if (itemCount < childCount - 1) {
                for (int i = childCount - 1; i >= itemCount; i--) {
                    ...
                    child.setTag(R.id.stack_view_position, -1);
            ...
            for (int i = 0; i < itemCount; i++) {
                View child = getChildAt(i);
                if (child == null) {
                    child = mAdapter.getView(i, null, StackScrollLayout.this);
                    addView(child);
                } else {
                    mAdapter.getView(i, child, StackScrollLayout.this);
                }
                child.setTag(R.id.stack_view_position, i);
            }
        }
    ...
    public StackScrollLayout(Context context, AttributeSet attrs) {
    ...
    private void initView(Context context) {
        ...
        if (Define.SDK_INT < 21) {
            ...
            mCollapsedSize += shadowRadius;
            mPaddingBetweenElementsNormal = Math.max(mPaddingBetweenElementsNormal - shadowRadius, 0);
            mPaddingBetweenElementsDimmed = Math.max(mPaddingBetweenElementsDimmed - shadowRadius, 0);
        }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int childMeasureSpec = View.MeasureSpec.makeMeasureSpec(size - 2 * mSidePaddings, mode);
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        for (int i = 0; i < getChildCount(); i++) {
            ...
            child.layout((int) (centerX - width / 2.0f), 0,
                    (int) (centerX + width / 2.0f), (int) height);
        }
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        ...
        if (mScrollView != null && mDelegateToScrollView) {
            if (isCancelOrUp) {
        ...
        switch (action & MotionEvent.ACTION_MASK) {
            ...
            case MotionEvent.ACTION_UP:
                if (mIsBeingDragged) {
                   ...
                   if (shouldOverScrollFling(initialVelocity) && !mEnableOverScroll) {
                            ...
                            if ((Math.abs(initialVelocity) > mMinimumVelocity)) {
                                ...
                                if (currentOverScrollTop == 0.0f || initialVelocity > 0) {
                                    ...
                                    if (mEnableOverScroll) {
                                        if (mScroller.springBack(getScrollX(), mOwnScrollY, 0, 0, 0,
                                                getScrollRange())) {
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        ...
        if (mScrollView != null && mInterceptDelegateEnabled) {
            transformTouchEvent(ev, this, mScrollView);
    ...
    public void setAdapter(StackViewBaseAdapter adapter) {
    ...
    public void performClick(View v) {
        int position = (int) v.getTag(R.id.stack_view_position);
        if (onItemClickListener != null) {
            onItemClickListener.onItemClick(this, v, position, mAdapter.getItemId(position));
        }
    }
    ...
    public interface OnItemClickListener {
        void onItemClick(StackScrollLayout parent, View itemView, int position, long id);
    }
