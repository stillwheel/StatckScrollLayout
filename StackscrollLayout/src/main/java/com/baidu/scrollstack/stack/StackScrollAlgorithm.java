 ...
 * StackScrollLayout} which can be queried for {@link com.android.systemui.statusbar
...
public class StackScrollAlgorithm {
    ...
    private void initConstants(Context context) {
        ...
        if (Define.SDK_INT < 21) {
            int shadowRadius = context.getResources().getDimensionPixelSize(
    ...
    private void updateDimmedActivatedHideSensitive(AmbientState ambientState,
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            childViewState.scale = !mScaleDimmed || !dimmed || false
                    ? 1.0f
                    : DIMMED_SCALE;
        }
    }
    ...
    private void updatePositionsForState(StackScrollState resultState,
        ...
        for (int i = 0; i < childCount; i++) {
            ExpandableView child = algorithmState.visibleChildren.get(i);
            float preYPosition = currentYPosition;
            StackScrollState.ViewState childViewState = resultState.getViewStateForView(child);
